...
%
%<*Chapter12>
\maketitle{12}{Food Safety and Technology: Protecting Our Food}%
% TODO: Get the rest of the tables for Chapter 12
...
\begin{table}[H]
	...
	\begin{adjustbox}{max width=0.975\paperwidth,center}
		\begin{tabular}{p{0.4\paperwidth} p{0.1\paperwidth} p{0.4\paperwidth} p{0.1\paperwidth}}
			\rowcolor{rowdarkgreen}%
			\textbf{Name of Agency} & \textbf{Year Founded} & \textbf{Role in Food Regulations} & \textbf{Website}\\
			U.S\@. Department of Agriculture (USDA) Food Safety and Inspection Service (FSIS) & 1785 & Oversees safety of meat, poultry, and processed egg products; also ensures accuracy of meat and poultry labeling & \url{www.fsis.usda.gov}\\
			U.S\@. Food and Drug Administration (FDA) & 1862 & Regulates food standards of food products (except meat, poultry, and eggs) and bottled water; regulates food labeling and enforces pesticide use as established by EPA & \url{www.fda.gov}\\
			Centers for Disease Control and Prevention (CDC) & 1946 & Works with public health officials to promote and educate the public about health and safety; is able to track information needed in identifying foodborne illness outbreaks & \url{www.cdc.gov}\\
			U.S\@. Environmental Protection Agency (EPA) & 1970 & Regulates use of pesticides and which crops that can be applied to; establishes standards for water quality & \url{www.epa.gov}\\
			\rowcolor{rowdarkgreen} & & &
		\end{tabular}
	\end{adjustbox}
\end{table}
